...
def write_page(structured_blocks, page_num, total_pages):
    ...
    with open(filename, 'w', encoding='utf-8') as f:
        ...
        f.write('</div>\n')
        f.write('<div style="text-align:center;margin:2em 0 1em 0;font-size:0.9em;color:#666;">\n')
        f.write('These poems are Avi\'s diary. You can email him at <a href="mailto:avi@invariablyhappy.com" style="color:#6b4c7a;">avi@invariablyhappy.com</a>\n')
        f.write('</div>\n')
        f.write('  </main>\n')
